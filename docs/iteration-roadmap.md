...
- P0.551 live provider evidence next action uses the full validation-aware handoff chain
...
- P0.620 final local report refresh preserves granular configured evidence consent actions
