...
![P0.7 iOS flow rendered from a 390x844 viewport as a full-page capture](assets/p0.7-ios-flow-390x844.png)

## Browser Check

- URL: `http://127.0.0.1:8127/p0.7-ios-flow.html`
- Viewport: `390x844`
- Screenshot mode: full page; image height is taller than the viewport because
  it captures the complete scrollable flow.
- Console errors: `[]`
