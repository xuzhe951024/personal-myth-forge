...
def test_object_capture_manifest_serializes_without_bytes_or_local_paths() -> None:
    ...
    assert payload["capture_id"] == "cap_0123456789abcdef"
    assert payload["media_items"][0]["uri"] == "local-capture://cap_0123456789abcdef/media_0.jpg"
...
- [x] **Step 1: Write failing local capture store tests**
...
- [x] **Step 3: Ignore local capture storage**
...
- [x] **Step 4: Add capture store implementation**
...
- [x] **Step 5: Add settings and factory**
...
- [x] **Step 6: Run store tests and full provider tests**
...
- [x] **Step 1: Add multipart dependency**
...
- [x] **Step 2: Write failing capture upload API tests**
...
- [x] **Step 5: Run capture API tests**
...
- [x] **Step 1: Write failing myth-from-capture API test**
...
- [x] **Step 2: Write failing pipeline capture-reference test**
...
- [x] **Step 4: Include capture refs in object card**
...
- [x] **Step 5: Add myth-from-capture route**
...
- [x] **Step 6: Run capture and pipeline tests**
...
- [x] **Step 1: Write failing demo HTML contract test**
...
- [x] **Step 2: Run demo test to verify it fails**
...
- [x] **Step 4: Update demo JavaScript**
...
- [x] **Step 6: Run API contract tests**
...
- [x] **Step 1: Write mobile contract fixtures**
...
- [x] **Step 2: Write mobile capture contract doc**
...
- [x] **Step 1: Run functional verification**
...
- [x] **Step 2: Run browser visual regression**
...
- [x] **Step 3: Write browser evidence report**
...
- [x] **Step 4: Final status and commit**
