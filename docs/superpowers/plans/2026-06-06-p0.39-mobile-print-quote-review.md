...
- [ ] **Step 4: Add sample print candidate helper**
...
- [ ] **Step 1: Load the new source file in project checks**
...
- [ ] **Step 2: Require Xcode project membership**
...
- [ ] **Step 3: Require root view wiring**
...
- [ ] **Step 4: Require view safety and display**
...
- [ ] **Step 1: Create `PrintQuoteReviewView`**
...
- [ ] **Step 3: Wire Xcode project source**

In `project.pbxproj`, add these entries following the local numeric pattern:

```text
10A000000000000000000013 /* PrintQuoteReviewView.swift in Sources */ = {isa = PBXBuildFile; fileRef = 10B000000000000000000013 /* PrintQuoteReviewView.swift */; };
10B000000000000000000013 /* PrintQuoteReviewView.swift */ = {isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = PrintQuoteReviewView.swift; sourceTree = "<group>"; };
```

Add `10B000000000000000000013 /* PrintQuoteReviewView.swift */,` to the App
