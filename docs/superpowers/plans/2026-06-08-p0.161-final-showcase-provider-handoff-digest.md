...
- [ ] **Step 3: Implement provider handoff stage**
...
- [ ] Fast-forward merge `codex/p0.161-final-showcase-provider-handoff-digest` into `main`.
- [ ] Re-run the verification set on `main`.
- [ ] Remove the P0.161 worktree if verification passes.
- [ ] Refresh local readiness reports and confirm remaining blockers are external-resource/device gates.
