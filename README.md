...
gate now checks 27 static 390x844 iPhone evidence artifacts covering scan input,
...
URL handoff, configured evidence, resource fill guide, device evidence, closure
packet, final launch visual handoff, and the device blocker handoff visual.
