...
gate now checks 28 static 390x844 iPhone evidence artifacts covering scan input,
...
URL handoff, final showcase device actions, configured evidence, resource fill
guide, device evidence, closure packet, final launch visual handoff, and the
