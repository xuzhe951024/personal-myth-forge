...
do {
    ...
    let artifactSceneLoadProof = try readText(coreRoot.appendingPathComponent("ArtifactSceneLoadProof.swift"))
    ...
    try requireContains(artifact3DPreviewView, "ArtifactSceneLoadProofBuilder.build", "SceneKit proof builder wiring")
    try requireContains(artifact3DPreviewView, "sceneLoadProof", "SceneKit proof view state")
    try requireContains(artifact3DPreviewView, "sceneLoadFailure(detail:", "SceneKit parse failure state")
    ...
    try requireContains(artifactAssetPreparation, "sceneLoadFailed", "SceneKit parse failure prepared asset state")
    try requireContains(artifactSceneLoadProof, "ArtifactSceneLoadProofBuilder", "SceneKit load proof builder")
    try requireContains(artifactSceneLoadProof, "ArtifactSceneLoadProofStatus", "SceneKit load proof status")
    try requireContains(artifactSceneLoadProof, "SceneKit load proof", "SceneKit load proof user-facing copy")
